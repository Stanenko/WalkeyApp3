...
import { View, Text, Image, ScrollView, TouchableOpacity, Switch, Dimensions } from 'react-native';
        ...
        <View className="mt-5">
          ...
          <ScrollView horizontal className="mt-3">
            ...
            <View className="bg-gray-100 rounded-lg p-3 mr-3">
              <Image
                source={{ uri: 'https://example.com/friend1' }} // Замените на фактическое изображение
            ...
            <View className="bg-gray-100 rounded-lg p-3 mr-3">
              <Image
                source={{ uri: 'https://example.com/friend2' }} // Замените на фактическое изображение
                className="w-16 h-16 rounded-full"
              />
              <Text>Кай</Text>
            </View>
            ...
            <View className="bg-gray-100 rounded-lg p-3">
              <Image
                source={{ uri: 'https://example.com/friend3' }} // Замените на фактическое изображение
                className="w-16 h-16 rounded-full"
              />
              <Text>Каспер</Text>
            </View>
